...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO details (detail_name, detail_description, detail_url, detail_image, category_name, category_type) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssss", $detail_name, $detail_description, $detail_url, $detail_image, $category_name, $category_type);
